...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Stay legally compliant <br className='sm:block hidden'/></h1>
    <p className="subtitle">Find tailored solutions for your business<br className='sm:block hidden'/></p>
    <p className="subtitle">
      <Link className={styles.cta} href="https://www.comply.me/registracia/">Get started <span>→</span></Link>
    </p>
  </div>
  <style jsx>{`
    .content-container {
  ...
  <div className="features-container">
    <div className="content-container">
      <Features>
        <Feature index={2} href="/compliance">
          <h3>Business Compliance <br className="show-on-mobile"/></h3>
        ...
        <Feature index={3} href="/register">
          <h3>Business <br className="show-on-mobile"/>Formation</h3>
          <p className='mb-4'>Register your business in minutes</p>
          <I18n/>
        </Feature>
        ...
        <Feature index={5} centered className="feat-darkmode" style={{
          ...
          >Find <br/>Tailored <br/>Solutions</motion.h3>
        </Feature>
        <Feature index={6} large id="search-card" href="/taxes">
          <div style={{ zIndex: 2}}>
            <h3>Embrace worry-free tax filings <br/>Avoid penalities</h3>
            <p>You can be fined $25,000 for inaccurate or missing forms</p>
          </div>
        ...
        <Feature index={0} large centered id="docs-card" href="/register">
          <Image src={docsCard} alt="Background" loading="eager" />
          <Image src={docsCardDark} alt="Background (Dark)" loading="eager" />
          <h3>Form a company <br className="show-on-mobile"/>in minutes</h3>
        </Feature>
        <Feature index={1} centered className="card-with-border" href="https://www.comply.me/category/outsourcing-hr/">
          <div className="h-full flex flex-col justify-between">
            <h3>Find local labor <br className="show-on-mobile"/>compliance <span className="font-light">solutions </span></h3>
            <p className='text-left mb-8'>Hire internationally and pay talent anywhere</p>
            <div>
              <div className={styles.optimization}>
                <div style={{ fontSize: '.9rem' }} className="leading-8">
                  <code>{`Multi-country payroll management`}</code>
                  <br/>
                  <code>{`Guided Global HR Compliance`}</code>
                </div>
              </div>
              <ArrowRightIcon width="1.2em" className="text-neutral-400 rotate-90 my-6 mx-auto" />
              <div className={styles.optimization}>
                <div style={{ fontSize: '.9rem' }} className="leading-8">
                  <code>{`Global PEO & EOR services`}</code>
                  <br/>
                  <code>{`Hire and expand across the globe legally`}</code>
                </div>
              </div>
            </div>
          </div>
        </Feature>
        <Feature index={9} href="https://www.comply.me/registracia/">
          <h3>Manage compliance issues <br/> </h3>
          <p className='mr-6'>Keep your business in good standing with required filings and annual reports.</p>
        </Feature>
        <Feature index={10} large>
          <h3>Comply.Me</h3>
          <p>One-Stop Shop for all regulatory <b>Federal</b> and <b>State requirements</b></p>
          <p className="subtitle"><Link className="!no-underline" href="https://www.comply.me/">Start with Comply.Me →</Link></p>
        </Feature>
