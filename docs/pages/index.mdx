...
<div className="home-content">
  <div className="content-container">
    ...
    <p className="subtitle">Find tailored solutions for your regulatory needs<br className='sm:block hidden'/><a className="nextjs-link" href="https://nextjs.org" target="_blank">Taxes, licenses, permits, certificates, annual reports</a></p>
